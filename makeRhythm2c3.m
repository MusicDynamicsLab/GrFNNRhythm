...
%% Connections                     
% Internal
n1 = connectAdd(n1, n1, C0, 'weight', w/4, 'type', '2freq', .05);

% Afferent
n2 = connectAdd(n1, n2, C1, 'weight', w/.8, 'type', '2freq', .05);

% Internal
n2 = connectAdd(n2, n2, C0, 'weight', w/3, 'type', '2freq', .05);

% Efferent
n1 = connectAdd(n2, n1, C1, 'weight', w/8, 'type', '2freq', .05);
